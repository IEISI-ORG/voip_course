# Lab M13 — Authentication, Authorization & Caller Identity

**Module:** [M13](../../../course/modules/13-authn-authz-identity.md) · **Est.** 6h ·
**Prereqs:** M6–M12. **Checkpoint Exam #2 follows this module.**
...
## Auto-graded core
```bash
bash labs/m13-authn-identity/verify.sh          # enumeration ban (self-validating) + PASSporT tool
...
```bash
bash labs/m13-authn-identity/verify.sh          # svwar -> banned
```
