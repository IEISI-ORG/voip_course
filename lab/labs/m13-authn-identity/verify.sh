...
if bash labs/m13-authn-identity/passport-decode.sh 2>/dev/null | grep -q '"attest":"A"'; then
...
echo
echo "== note: base defense = scanner-UA ban; the full M13 build adds uniform auth responses,"
