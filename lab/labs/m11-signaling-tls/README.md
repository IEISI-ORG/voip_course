# Lab M11 — Signaling Security: TLS & SIPS

**Module:** [M11](../../../course/modules/11-signaling-security-tls.md) · **Est.** 5h ·
**Prereqs:** M6–M9.
...
## Auto-graded core
```bash
bash labs/m11-signaling-tls/verify.sh        # TLS handshake + SIP transaction over :5061
bash labs/m11-signaling-tls/tls-check.sh     # cert subject/expiry + live handshake
```
