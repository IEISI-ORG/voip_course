...
**Modules:** [M15](../../../course/modules/15-threats-offensive-testing.md) (attack) →
**detect** → [M17](../../../course/modules/17-monitoring-observability-ir.md) (respond). Feedback-
...
| Wired to M17 (Wazuh/Grafana sees the alert) | 20 | alert visible in the obs plane |
