# Lab M18 — Frontiers: VoLTE/IMS, FoIP, ENUM/Peering, UC/UCaaS/CPaaS

**Module:** [M18](../../../course/modules/18-frontiers.md) · **Est.** 5h · **Prereqs:** M1–M17.
...
```bash
bash labs/m18-frontiers/verify.sh                    # ENUM encoding + private routing (offline)
bash labs/m18-frontiers/enum-lookup.sh "+1 415 555 0100"
```
...
Show an abusive caller (over-rate or over-cap) blocked, and the event alerted (M16).
...
— covers operations across M14–M18 and the whole platform.
