...
1. **Detect** — which alert/signature fired (link the M16 rule).
...
- **Detect:** `TollFraudSpend` (spend cap breach) / M15 fraud-detect.
...
- **Recover:** confirm media is encrypted end-to-end; review recordings' at-rest encryption (M15).
