# Lab M15 — Defense, Hardening & Fraud Prevention

**Module:** [M15](../../../course/modules/15-defense-hardening-fraud.md) · **Est.** 6h ·
**Prereqs:** M14.

Goal: turn the M14 findings into a hardened platform and stop toll fraud before it drains a budget.

## Auto-graded core
```bash
bash labs/m15-defense-fraud/verify.sh          # fraud detector + hardening checklist (offline)
bash labs/m15-defense-fraud/fraud-detect.sh    # scan the sample CDR
```
...
```bash
bash labs/m15-defense-fraud/fraud-detect.sh labs/m15-defense-fraud/sample-cdr.csv
CAP=100 PREFIX_CAP=50 bash labs/m15-defense-fraud/fraud-detect.sh your-cdr.csv
```
...
Re-run the M14 assessment (`labs/m14-offensive/`) against the hardened platform and produce a
