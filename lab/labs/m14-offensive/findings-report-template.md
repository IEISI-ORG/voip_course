...
- **Remediation:** <concrete fix + module reference, e.g. "enable pike (M7), fail2ban (M15)">
- **Detection signature (Lab 13.2 → M16):** <log pattern / metric / Wazuh rule that catches it>
