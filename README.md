...
- **Iteration:** 33 · **Date:** 2026-07-03 · **HEAD tracks:** see `git log --oneline -1`
...
- **Next:** feedback-driven BF labs, capstone grading harness (C2), HTML MC exams (E1), MARP slides (E4)
