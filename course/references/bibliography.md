...
| S. Bernard, "Strategies to Secure a Voice over Internet Protocol Telephone System," Doctoral study (D.I.T.), Walden University, 2022. ScholarWorks: https://scholarworks.waldenu.edu/dissertations | Instructor governance slide | Qualitative multiple-case study of strategies IT security managers use. Four themes: best practices, choosing a secure provider, security recommendations, awareness of future concerns. Practitioner recommendations: **encryption-first**, early-breach **monitoring**, staff/customer **training**, and masking card numbers spoken over the phone (cf. BF8 DTMF/PAN masking). |
