...
| G. K. Gegenhuber, F. Holzbauer, et al., "Diffie-Hellman Picture Show: Key Exchange Stories from Commercial VoWiFi Deployments," *33rd USENIX Security Symposium (USENIX Security '24)*, 2024. arXiv:2407.19556. | M19 VoWiFi; M11 crypto | Peer-reviewed measurement of commercial VoWiFi: **13 operators (~140M users)** use weak/deprecated IKE **Diffie-Hellman groups**, downgradeable to breakable — VoWiFi setups susceptible to MITM. Evidence for mandating strong key exchange + rejecting downgrade. |
| R. Dantu, S. Fahmy, H. Schulzrinne, J. Cangussu, "Issues and Challenges in Securing VoIP," *Computers & Security* (Elsevier), 2009. DOI 10.1016/j.cose.2009.05.003. | M1 architecture; M15 threats | Peer-reviewed (co-authored by H. Schulzrinne, an author of RFC 3261/SIP). Proposes a high-level security architecture that captures the required features **at each boundary network element** of the VoIP infrastructure — the framing this course's edge/core/SBC layering follows. |
| A. Mohd Ramly, Z. W. Ng, Y. Khamayseh, C. S. C. Kwan, A. Amphawan, T.-K. Neo, "Review and Enhancement of VoIP Security: Identifying Vulnerabilities and Proposing Integrated Solutions," *Journal of Telecommunications and the Digital Economy*, vol. 12, no. 4, 2024. DOI 10.18080/jtde.v12n4.1022. | M15 threats | Recent peer-reviewed review of VoIP vulnerabilities (eavesdropping, registration/call hijacking, SPIT, vishing, malware) and layered/integrated mitigations. |
...
| Australian Telecommunications Alliance, **C674:2025**, *Emergency Calling – Network and Mobile Phone Testing*, 2025. https://www.austelco.org.au | M19/BF2 emergency (AU 000) | AU industry **code** governing emergency-call handling/testing, incl. the SIP-header requirements for AU emergency calls. A national code of conduct — high-priority authority. (© ATA; cited, not reproduced.) |
...
| **Communications Alliance C536:2025**, *Emergency Call Service Requirements*. https://www.commsalliance.com.au | M19/BF2 emergency (AU 000) | AU industry **code** on emergency-call-service obligations (complements C674's testing/SIP-header requirements). |
...
| **EECC** — Directive (EU) 2018/1972 (European Electronic Communications Code), **Article 109**. https://eur-lex.europa.eu/eli/dir/2018/1972/oj | M19/BF2 emergency (EU 112) | The EU legal mandate: every ECS provider must supply **free** emergency communications and transmit **precise caller location** (network-based **and** handset-derived) to the PSAP **without delay**. |
| **ETSI TS 103 479** V1.2.1 (2023-03), *Emergency Communications (EMTEL); Core elements for network independent access to emergency services*. https://www.etsi.org | M19/BF2 emergency (EU/NG112) | The **NG112** reference architecture — BCF, ESRP, ECRF, PSAP, LIS, BRIDGE. The EU standard behind IP emergency-call routing/location. |
| **EENA** — European Emergency Number Association (112 operational guidance & AML). https://eena.org | M19/BF2 emergency (EU 112) | The pan-European body for 112; guidance on Advanced Mobile Location (AML) handset-derived location and PSAP operations. |
...
## 11d. Mobile / VoWiFi (GSMA PRDs — standards class)
| Doc | Relevance | Note |
|-----|-----------|------|
| GSMA **IR.51** — *IMS over Wi-Fi (VoWiFi)* profile; **IR.61** — *Wi-Fi Roaming Guidelines*. https://www.gsma.com | M19 VoWiFi | The carrier profiles for Wi-Fi calling: IMS carried over IPsec/IKEv2 to the ePDG. Companion to IR.92 (VoLTE)/IR.94. |
