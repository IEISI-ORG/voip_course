...
| S. S. Kolahi, K. Mudaliar, C. Zhang, Z. Gu, "Impact of IPSec Security on VoIP in Different Environments," Unitec Institute of Technology, NZ, 2013. | M9 trunk security; security-vs-performance | Test-bed comparison (IPv4/IPv6/6in4, ±IPsec): IPsec raised **CPU usage** and added **delay**; throughput ~unchanged; RTT/jitter results **inconsistent**. Takeaway used carefully (small single test-bed): encryption overhead is real and must be capacity-budgeted. |
