# Checkpoint Exam #3 — Operations (after M19)

Covers **operations across M15–M19** and running the whole platform: offensive testing, defense
...
7. (5) Why must every M15 finding have a detection signature? What's the failure otherwise?
