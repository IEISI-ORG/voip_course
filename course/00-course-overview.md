...
## 5. Module Map (20 modules + capstone)
...
| 14 | Provisioning & Device Configuration Security | HTTPS provisioning, TFTP, config encryption | Plaintext configs, MAC-URL enumeration, RPS/redirection abuse (T15) | 4 |
| 15 | VoIP Threats & Offensive Testing | SIPVicious, SIPp, custom fuzzers | Authorized red-team methodology | 5 |
| 16 | Defense, Hardening & Fraud Prevention | fail2ball, Wazuh, CDR analytics | Toll fraud, IRSF, DoS mitigation | 6 |
| 17 | Monitoring, Observability & Incident Response | HOMER, Prometheus, Grafana, Loki | Detection, IR runbooks, forensics | 5 |
| 18 | Testing, Interop, Automation & Cloud | SIPp, Docker/K8s, Ansible, Terraform, CI | Secure pipelines, config drift | 5 |
| 19 | Frontiers: VoLTE/IMS, FoIP, ENUM/Peering, UC/UCaaS/CPaaS | Kamailio IMS, spandsp, BIND | IMS/peering trust, RCS/OTT risks | 5 |
...
- **Three checkpoint exams:** after M5 (protocol), M13 (build+security), M19 (operations).
...
- `modules/00-orientation-and-lab.md` … `modules/19-frontiers.md` — per-module deep dives.
