...
signaling-security skill and the entry point for the WebRTC media work in M12.
...
- **Lab hook (adds B10+):** a browser softphone registers over `wss://` to `edge-sbc`; capture
  and verify the TLS-wrapped WebSocket handshake. Media bridging continues in M12.
