...
6. **Authorized red-team report** — full assessment (M13 methodology) against the final platform,
   with before/after deltas showing earlier findings remediated.
7. **Observability** — KPI dashboards, alerts covering all M13 signatures, detection-coverage map.
...
1. Detect: spend/velocity/off-hours alert (M15).
