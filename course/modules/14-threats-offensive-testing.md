# Module 14 — VoIP Threats & Offensive Testing (Authorized)
...
- Produce findings that drive the Module 15 hardening.
...
- Capture and fingerprint each attack's signature (what svmap/svwar/floods look like on the
  wire and in HOMER) — this is the detection training for M16.
...
- **Lab 13.2:** For each finding, capture its detection signature for M16.
